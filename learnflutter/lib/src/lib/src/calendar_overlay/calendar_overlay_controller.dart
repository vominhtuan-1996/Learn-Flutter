...
class CalendarOverlayController extends StateController<CalendarOverlay> {
  ...
  void readyState() {
    ...
    years.addAll(List.generate(7, (index) => index));
    onDate(currentDate());
...
extension DateTimeFormat on DateTime {
  String locale(BuildContext context) => Localizations.localeOf(context).languageCode;
  ...
  bool isInTheSameDay(DateTime other) => year == other.year && month == other.month && day == other.day;
