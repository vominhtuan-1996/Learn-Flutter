...
import 'package:learnflutter/component/multi_select/multi_select_cubit.dart';
import 'package:learnflutter/core/app/device_dimension.dart';
import 'package:learnflutter/core/global/func_global.dart';
import 'package:learnflutter/custom_widget/empty_widget.dart';
import 'package:learnflutter/custom_widget/tap.dart';
import 'package:learnflutter/shared/widgets/app_divider.dart';
import 'package:mobimap_module/ui/app_text.dart';
...
class _MultiSelectorState<T> extends State<MultiSelector<T>> {
        ...
        child: Container(
          ...
          decoration: widget.decoration ??
              BoxDecoration(
                ...
                border:
                    Border.all(color: getThemeBloc(context).state.tokens.colors.background, width: 0.5),
              ),
  ...
  Widget buildItem(T item, bool isSelected) {
    ...
    return Tap(
      ...
      disableColor: getThemeBloc(context).state.tokens.colors.background.withValues(alpha: 0.5),
