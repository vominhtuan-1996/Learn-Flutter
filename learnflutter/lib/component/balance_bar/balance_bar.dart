...
class BalaneceBarView extends StatelessWidget {
  const BalaneceBarView({
    super.key,
  ...
  Widget build(BuildContext context) {
    return CustomPaint(
      ...
      child: Padding(
        ...
        child: BalanceBar(contentAlignment: Alignment.topCenter),
      ),
    );
  }
}
...
class _CardPainter extends CustomPainter {
  ...
  void paintCircle(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(Offset(halfX, stopY), 10, paint);
  }
