...
class _BarColorPickerState extends State<BarColorPicker> {
  ...
  late final double barWidth, barHeight;
...
class _CircleColorPickerState extends State<CircleColorPicker> {
  ...
  Widget build(BuildContext context) {
    ...
    final double thumbCenterX = radius + thumbDistanceToCenter * sin(thumbRadians);
    final double thumbCenterY = radius + thumbDistanceToCenter * cos(thumbRadians);
