...
class MaterialScreenState extends State<MaterialScreen> with TickerProviderStateMixin {
  ...
  List components = [
    ...
    RoouterMaterialModel('Dialogs', Routes.datetimePickerScreen,
    ...
    RoouterMaterialModel('Dividers', Routes.datetimePickerScreen, 'A divider is a thin line used to group content in lists and layouts.'),
    RoouterMaterialModel('Floating action buttons (FAB)', Routes.datetimePickerScreen, 'FABs help people take primary actions. They’re used to represent the most important action on a screen.'),
    ...
    RoouterMaterialModel('Progress indicators', Routes.datetimePickerScreen,
