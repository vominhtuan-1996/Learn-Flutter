// ignore_for_file: unnecessary_overrides, unnecessary_new, unnecessary_null_comparison, non_constant_identifier_names, library_private_types_in_public_api, avoid_print, prefer_const_constructors, sort_child_properties_last
...
typedef SectionHeaderHeightCallBack = double Function(int section);
typedef DividerHeightCallBack = double Function();
typedef CellHeightAtIndexPathCallBack = double Function(int section, int row);
typedef SectionTableViewScrollToCallBack = void Function(
...
class SectionTableController extends ChangeNotifier {
  ...
  SectionTableController({required this.sectionTableViewScrollTo});
  ...
  Future<bool> animateTo(int section, int row) {
    ...
    dirty = true;
    notifyListeners();
    return Future.delayed(const Duration(milliseconds: 251), () => true);
  }
}
...
class SectionTableView extends StatefulWidget {
  ...
  SectionTableView({
    ...
    required this.headerInSection,
    required this.divider,
    required this.sectionHeaderHeight,
    required this.dividerHeight,
    required this.cellHeightAtIndexPath,
...
class _SectionTableViewState extends State<SectionTableView> {
  ...
  late double preIndexOffset;
  late double nextIndexOffset;
...
//        print('scroll offset $currentOffset');
        if (currentOffset < preIndexOffset) {
          ...
          if (currentIndex > 0) {
            ...
            nextIndexOffset =
                indexPathToOffsetSearch[nextIndexPath.toString()]!;
