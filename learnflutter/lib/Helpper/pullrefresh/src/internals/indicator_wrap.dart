// ignore_for_file: unnecessary_null_comparison, prefer_const_constructors_in_immutables, unnecessary_new
...
abstract class Wrapper extends StatefulWidget {
  ...
  int get mode => modeListener.value;

  set mode(int mode) => modeListener.value = mode;
  ...
  void _handleModeChange() {
    switch (mode) {
      ...
      case RefreshStatus.completed:
        Future.delayed(new Duration(milliseconds: widget.completeDuration), () {
          _dismiss();
        });
        break;
...
class LoadWrapperState extends State<LoadWrapper> implements GestureProcessor {
  late VoidCallback _updateListener;
