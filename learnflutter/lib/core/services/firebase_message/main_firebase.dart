...
// import 'package:learnflutter/core/services/firebase_message/message.dart';
// import 'package:learnflutter/core/services/firebase_message/message_list.dart';
// import 'package:learnflutter/core/services/firebase_message/permission.dart';
// import 'package:learnflutter/core/services/firebase_message/token_monitor.dart';
...
// ///     c. Copy the token that is loged in the console and paste it here: https://github.com/firebase/flutterfire/blob/01b4d357e1/packages/firebase_messaging/firebase_messaging/example/lib/main.dart#L32
...
//         ),
//       ),
//       payload: message.data['screen'] ?? 'default', // ✅ Truyền payload để xử lý tap
//     );
//   }
// }

// void checkFirebaseProject() {
//   final options = Firebase.app().options;
//   log('Current Firebase Project ID: ${options.projectId}');
//   log('Current Firebase Project ID: ${options.iosBundleId}');
//   log(' $options');
// }
...
//       } else {
//         log('Error sending FCM request: ${result.statusCode}');
//       }
//       log('FCM request for device sent!');
//     } catch (e) {
//       log(e.toString());
...
//                 ),
//                 const PopupMenuItem(
//                   value: 'checkFirebaseProject',
//                   child: Text('checkFirebaseProject'),
//                 ),
//               ];
//             },
//           ),
...
//       body: Center(child: Text('Token: $_token')),
//     );
//   }
// }
