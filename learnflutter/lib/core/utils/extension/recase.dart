...
class ReCase {
  ...
  /// Header_Case_Underlined
  String get headerUnderlinedCase => _getPascalCase(separator: '_');
...
extension ValidateString on String {
  ...
  bool get isContainUnicode {
    const int maxBits = 128;
    return codeUnits.any((ch) => ch > maxBits);
  }
}

extension AdditionCheck on String? {
  bool get isNullOrEmpty => (this ?? '').isEmpty;
  String get formatNullEmpty => isNullOrEmpty ? '-' : this!;
}
