...
import 'package:learnflutter/shared/components/multi_select/multi_selector.dart';
import 'package:learnflutter/shared/components/multi_select/selector/selector.dart';
import 'package:learnflutter/shared/components/multi_select/selector/selector_cubit.dart';
import 'package:learnflutter/shared/components/multi_select/selector/selector_state.dart';
            ...
            if (loadMoreState.isLoading) {
              return Container(
                ...
                child: CircularProgressIndicator(
                    color: getThemeBloc(context).state.tokens.colors.primary),
              );
            }
            return Column(
              children: [
