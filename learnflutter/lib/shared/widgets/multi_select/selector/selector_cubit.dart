...
import 'package:learnflutter/core/models/option_model.dart';
import 'package:learnflutter/widgets/multi_select/selector/selector_state.dart';
...
class SelectorCubit<T extends OptionModel> extends Cubit<SelectorState<T>> {
  ...
  void init(List<T> items, List<T> selectedItems) {
    emit(state.copyWith(items: items, selectedItems: selectedItems, lastSelectedItems: selectedItems));
  }
