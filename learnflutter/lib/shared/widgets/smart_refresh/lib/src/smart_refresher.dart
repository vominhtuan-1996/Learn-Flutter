...
import 'package:learnflutter/shared/widgets/smart_refresh/lib/src/internals/slivers.dart';
...
class SmartRefresherState extends State<SmartRefresher> {
  ...
  Widget? _buildBodyBySlivers(
    ...
    if (childView is! Scrollable) {
      ...
      body = Scrollable(
        physics:
            _getScrollPhysics(conf, childView.physics ?? const AlwaysScrollableScrollPhysics()),
