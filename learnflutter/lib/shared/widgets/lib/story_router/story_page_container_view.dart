...
import 'package:learnflutter/shared/widgets/lib/story_router/first_build_mixin.dart';
...
class _StoryTimelineState extends State<StoryTimeline> {
  ...
  void initState() {
    _maxAccumulator =
        widget.buttonData.segmentDuration[widget.buttonData.currentSegmentIndex].inMilliseconds;
  ...
  void _onStoryComplete() {
    ...
    widget.controller
        ._onStoryComplete("${widget.buttonData.storyId}-${widget.buttonData.currentSegmentIndex}");
  }
