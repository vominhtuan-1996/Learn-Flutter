...
import 'package:learnflutter/features/material/component/material_lists/extendsion/sliver/widgets/sliver_snap.dart';
...
class SnappingScrollNotificationHandler {
  ...
  bool handleScrollNotification({
    ...
    final double expandThresholdPosition = (expandedBarHeight - collapsedBarHeight) / 1.75;
  ...
  void _snapAppBar({
    ...
    if (_shouldSnapAppBarFullyExpanded(
      ...
      _scrollToOffset(
        scrollController: scrollController,
        scrollToOffset: expandedBarHeight - collapsedBarHeight - bottomBarHeight,
      );
    }
  }
