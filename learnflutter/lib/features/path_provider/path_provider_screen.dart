...
class PathProviderScreen extends StatefulWidget {
  const PathProviderScreen({super.key, required this.title});
  final String title;

  @override
  State<PathProviderScreen> createState() => _MyPathProviderScreenState();
}

class _MyPathProviderScreenState extends State<PathProviderScreen> {
